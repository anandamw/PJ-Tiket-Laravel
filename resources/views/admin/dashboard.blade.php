                            ...
                            <div class="row justify-content-center gx-3">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="{{ asset('') }}assets/images/user-8.jpg"
                                                    class="rounded-3 wh-55" alt="user">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                ...
                                <div class="col-lg-6 col-sm-6">
                                    <div
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="{{ asset('') }}assets/images/user-10.jpg"
                                                    class="rounded-3 wh-55" alt="user">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                ...
                                <div class="col-lg-6 col-sm-6">
                                    <div
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="{{ asset('') }}assets/images/user-11.jpg"
                                                    class="rounded-3 wh-55" alt="user">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                ...
                                <div class="col-lg-6 col-sm-6">
                                    <div
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="{{ asset('') }}assets/images/user-12.jpg"
                                                    class="rounded-3 wh-55" alt="user">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                ...
                                <div class="col-lg-6 col-sm-6">
                                    <div
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="{{ asset('') }}assets/images/user-13.jpg"
                                                    class="rounded-3 wh-55" alt="user">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-sm-6">
                                        <div
                                            ...
                                            <div class="flex-shrink-0">
                                                <img src="{{ asset('') }}assets/images/planning-1.jpg"
                                    ...
                                    <div class="col-lg-12 col-sm-6">
                                        <div
                                            class="d-flex align-items-center rounded-3 bg-gray-div2 p-3 p-sm-2 p-md-3 mb-15">
                                            <div class="flex-shrink-0">
                                                <img src="{{ asset('') }}assets/images/planning-2.jpg"
                                                    class="rounded-3 wh-44" alt="planning">
                                            </div>
                                            <div class="flex-grow-1 ms-10">
                                    ...
                                    <div class="col-lg-12 col-sm-6">
                                        <div
                                            ...
                                            <div class="flex-shrink-0">
                                                <img src="{{ asset('') }}assets/images/planning-3.jpg"
                                                    class="rounded-3 wh-44" alt="planning">
                                            </div>
                                            <div class="flex-grow-1 ms-10">
                                    ...
                                    <div class="col-lg-12 col-sm-6">
                                        <div class="d-flex align-items-center rounded-3 bg-gray-div2 p-3 p-sm-2 p-md-3">
                                            <div class="flex-shrink-0">
                                                <img src="{{ asset('') }}assets/images/planning-4.jpg"
                                                    class="rounded-3 wh-44" alt="planning">
                                            </div>
                                            <div class="flex-grow-1 ms-10">
                            ...
                            <ul class="ps-0 mb-0 list-unstyled">
                                <li class="d-flex justify-content-between align-items-center">
                                    ...
                                    <span class="text-white fw-semibold">
                                        <i class="flaticon-bar-chart-4"></i> <span class="ms-2">66:15h</span>
                                    </span>
                                </li>
                                <li class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="card border-0 bg-gary-div2 rounded-3 mb-4 mb-lg-0">
                                <div class="card-body p-4">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <img src="{{ asset('') }}assets/images/c-plush.png" alt="c-plush">
                                    </div>
                                    <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="card border-0 bg-gary-div2 rounded-3 mb-4 mb-lg-0">
                                <div class="card-body p-4">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <img src="{{ asset('') }}assets/images/javascript.png" alt="javascript">
                                    </div>
                                    <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="card bg-white border-0 rounded-10 mb-4">
                <div class="card-body p-4">
                        ...
                        <ul class="nav nav-tabs border-0 courses-tab" id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link fs-18 fw-semibold border-0 active" id="enrolled-tab"
                                    data-bs-toggle="tab" data-bs-target="#enrolled-tab-pane" type="button"
                                    role="tab" aria-controls="enrolled-tab-pane"
                                    aria-selected="true">Enrolled</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link fs-18 fw-semibold border-0" id="created-tab" data-bs-toggle="tab"
                                    data-bs-target="#created-tab-pane" type="button" role="tab"
                                    aria-controls="created-tab-pane" aria-selected="false">Created</button>
                            </li>
                        </ul>
                        <div class="dropdown action-opt">
                            <button class="btn bg-transparent p-0" type="button" data-bs-toggle="dropdown"
                    ...
                    <div class="tab-content" id="myTabContent">
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="course-details.html"
                                                        ...
                                                        <div class="flex-shrink-0">
                                                            <img src="{{ asset('') }}assets/images/course-1.jpg"
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="course-details.html"
                                                        class="d-flex align-items-center mw-380">
                                                        <div class="flex-shrink-0">
                                                            <img src="{{ asset('') }}assets/images/course-2.jpg"
                                                                class="rounded-3 wh-75" alt="course">
                                                        </div>
                                                        <div class="flex-grow-1 ms-3">
                                                            <h4 class="fw-semibold fs-16 mb-0 lh-base hover">
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="course-details.html"
                                                        class="d-flex align-items-center mw-380">
                                                        <div class="flex-shrink-0">
                                                            <img src="{{ asset('') }}assets/images/course-4.jpg"
                                                                class="rounded-3 wh-75" alt="course">
                                                        </div>
                                                        <div class="flex-grow-1 ms-3">
                                                            <h4 class="fw-semibold fs-16 mb-0 lh-base hover">
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="course-details.html"
                                                        class="d-flex align-items-center mw-380">
                                                        <div class="flex-shrink-0">
                                                            <img src="{{ asset('') }}assets/images/course-5.jpg"
                                                                class="rounded-3 wh-75" alt="course">
                                                        </div>
                                                        <div class="flex-grow-1 ms-3">
                                                            <h4 class="fw-semibold fs-16 mb-0 lh-base hover">
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="course-details.html"
                                                        class="d-flex align-items-center mw-380">
                                                        <div class="flex-shrink-0">
                                                            <img src="{{ asset('') }}assets/images/course-8.jpg"
                                                                class="rounded-3 wh-75" alt="course">
                                                        </div>
                                                        <div class="flex-grow-1 ms-3">
                                                            <h4 class="fw-semibold fs-16 mb-0 lh-base hover">
                        ...
                        <div class="tab-pane fade" id="created-tab-pane" role="tabpanel" aria-labelledby="created-tab"
                            tabindex="0">
                            <div class="default-table-area course-list">
                                <div class="table-responsive">
                                    <table class="table align-middle">
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="course-details.html"
                                                        class="d-flex align-items-center mw-380">
                                                        <div class="flex-shrink-0">
                                                            <img src="{{ asset('') }}assets/images/course-6.jpg"
                                                                class="rounded-3 wh-75" alt="course">
                                                        </div>
                                                        <div class="flex-grow-1 ms-3">
                                                            <h4 class="fw-semibold fs-16 mb-0 lh-base hover">
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="course-details.html"
                                                        class="d-flex align-items-center mw-380">
                                                        <div class="flex-shrink-0">
                                                            <img src="{{ asset('') }}assets/images/course-7.jpg"
                                                                class="rounded-3 wh-75" alt="course">
                                                        </div>
                                                        <div class="flex-grow-1 ms-3">
                                                            <h4 class="fw-semibold fs-16 mb-0 lh-base hover">
                    ...
                    <ul class="ps-0 mb-0 list-unstyled messages-list" data-simplebar>
                            ...
                            <div class="d-sm-flex justify-content-between align-items-center">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0 position-relative">
                                        <img src="{{ asset('') }}assets/images/user-20.jpg"
                        ...
                        <li class="border-color-gray border-bottom p-4 active" id="my-element2">
                            <div class="d-sm-flex justify-content-between align-items-center">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0 position-relative">
                                        <img src="{{ asset('') }}assets/images/user-21.jpg"
                                            class="rounded-3 border border-color-gray2" alt="user">
                                        <div
                        ...
                        <li class="border-color-gray border-bottom p-4" id="my-element3">
                            <div class="d-sm-flex justify-content-between align-items-center">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0 position-relative">
                                        <img src="{{ asset('') }}assets/images/user-22.jpg"
                                            class="rounded-3 border border-color-gray2" alt="user">
                                        <div
                        ...
                        <li class="p-4" id="my-element4">
                            <div class="d-sm-flex justify-content-between align-items-center">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0 position-relative">
                                        <img src="{{ asset('') }}assets/images/user-23.jpg"
                                            class="rounded-3 border border-color-gray2" alt="user">
                                        <div
                    ...
                    <div class="row justify-content-center gx-3">
                        <div class="col-lg-6 col-sm-6 col-md-4 col-xxxl-12">
                            <div class="rounded-3 border-0 bg-gray-div2 p-3 mb-15">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="{{ asset('') }}assets/images/user-14.jpg"
                                            class="rounded-circle wh-44" alt="user">
                                    </div>
                                    <div class="flex-grow-1 ms-10">
                        ...
                        <div class="col-lg-6 col-sm-6 col-md-4 col-xxxl-12">
                            <div class="rounded-3 border-0 bg-gray-div2 p-3 mb-15">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="{{ asset('') }}assets/images/user-15.jpg"
                                            class="rounded-circle wh-44" alt="user">
                                    </div>
                                    <div class="flex-grow-1 ms-10">
