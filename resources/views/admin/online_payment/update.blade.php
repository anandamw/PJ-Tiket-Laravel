<div class="offcanvas offcanvas-end bg-white" data-bs-scroll="true" data-bs-backdrop="true" tabindex="-1"
    id="offcanvasScrollingUpdate{{ $itemData->online_payment_id }}" aria-labelledby="offcanvasScrollingLabel"
    ...
    <div class="offcanvas-body px-4">
        ...
        <form method="POST" action="/payment/update/{{ $itemData->online_payment_id }}">
            @csrf
            <div class="row">
                <div class="col-lg-12">
                ...
                <div class="col-lg-12">
                    <div class="form-group mb-4">
                        ...
                        <div class="form-group position-relative">
                            <input type="number" name="ticket_count" value="{{ $itemData->ticket_count }}" required
                                class="form-control text-dark ps-5 h-58" placeholder="Jumlah Tiket">
                            <i
                ...
                <div class="col-lg-12">
                    <div class="form-group mb-4">
                        ...
                        <div class="form-group position-relative">
                            <input type="text" name="total_price" value="{{ $itemData->total_price }}" required
                                class="form-control text-dark ps-5 h-58" placeholder="Total Harga">
                            <i
