                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($showTiket as $itemData)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span>{{ $itemData->ticket_code }}</span>
                                                    </td>
                                                    <td>
                                                            ...
                                                            <ul
                                                                ...
                                                                <li>
                                                                    <div class="dropdown-item" data-bs-toggle="offcanvas"
                                                                        data-bs-target="#offcanvasScrollingUpdate{{ $itemData->ticket_id }}"
                                                                ...
                                                                <li>
                                                                    <div class="dropdown-item" data-bs-toggle="modal"
                                                                        data-bs-target="#exampleModal4{{ $itemData->ticket_id }}">
                                                ...
                                                {{-- modal --}}
                                                <div class="modal fade" id="exampleModal4{{ $itemData->ticket_id }}"
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <a href="/tiket/delete/{{ $itemData->ticket_id }}"
